...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.out_layers = nn.ModuleDict(
            {task: nn.Linear(512, self.class_num)
    ...
    def forward(self, inputs, task):
        ...
        out = self.out_layers[task](out)
        return out

    def shared_parameters(self):
        return (p for n, p in self.named_parameters() if 'out_layers' not in n)

    def task_specific_parameters(self):
        return_list = []
        for task in self.task_name:
            return_list += [p for p in self.out_layers[task].parameters()]
        return return_list
...
class SingleTaskNet(nn.Module):
    ...
    def __init__(self):
        ...
        # task head
        self.out_layer = nn.Linear(512, self.class_num)
