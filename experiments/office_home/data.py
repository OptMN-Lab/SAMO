...
class Office_Dataset(Dataset):
    ...
    def __init__(self, root_path, task, mode):
        ...
        f = open(os.path.join(root_path, 'split/{}_{}.txt'.format(task, mode)),
                 'r')
    ...
    def __getitem__(self, i):
        ...
        img = Image.open(os.path.join(self.root_path, 'office',
...
def office_dataloader(batchsize, root_path):
    ...
    for k, d in enumerate(tasks):
        ...
        for mode in ['train', 'val', 'test']:
            ...
            txt_dataset = Office_Dataset(root_path, d, mode)
